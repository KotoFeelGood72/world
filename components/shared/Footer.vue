...
<template>
  <footer class="footer" v-if="option && contacts">
    <div class="container">
      <div class="footer_main">
        <div class="footer_col__info">
          ...
          <ul>
            <li>{{ option.global_phone }}</li>
            <li>{{ option.global_email }}</li>
            <li>{{ option.adress }}</li>
            <li>{{ option.legal_info }}</li>
          </ul>
        </div>
            ...
            <ul>
              ...
              <li>
                <NuxtLink
                  :to="{
                    name: 'shop',
                    query: { orderby: 'popularity', order: 'desc' },
                  }"
      ...
      <div class="footer_bottom">
        <ul>
          <li
            v-for="(item, i) in contacts.sociality"
            :key="'sociality-item-' + i"
          >
...
const { option } = useGlobalStoreRefs();
...
async function getAbout() {
  ...
  try {
    const response = await $custom.get("/kontakty.json");
